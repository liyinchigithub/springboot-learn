    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeRequests(authorize -> authorize
                .requestMatchers("/", "/home", "/login", "/login/wechat", "/login/wechat/callback", "/login/perform_login","/v1/users/addUser","/wechatLogin.html","/login/wechat/verify","/location","/test.png","/MP_verify_tSDyEHEKTxbBXHMd.txt").permitAll()// 允许未认证访问
